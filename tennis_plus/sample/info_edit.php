    ...
    <div>
      ...
      <form action="info_edit_do.php" method="post" class="needs-validation mb-3" novalidate>
        <div class="mb-3">
          ...
          <input type="text" name="title" id="title" class="form-control" value="<?php echo $target['title']; ?>" required>
        ...
        <div class="mb-3 row">
          ...
          <div class="col">
            ...
            <input type="text" name="author" id="author" class="form-control" value="<?php echo $target['author']; ?>" required>
            <div class="invalid-feedback">
              投稿者を入力してください
            </div>
          </div>
