    ...
    <div>
      ...
      <form action="info_edit_do.php" method="post" class="needs-validation mb-3" novalidate>
        <div class="mb-3">
          ...
          <input type="text" name="title" id="title" class="form-control" value="<?php echo $target['title']; ?>">
        ...
        <div class="mb-3 row">
          ...
          <div class="col">
            ...
            <input type="text" name="author" id="author" class="form-control" value="<?php echo $target['author']; ?>">
            <div class="invalid-feedback">
              投稿者を入力してください
            </div>
          </div>
        ...
        <div class="mb-3">
          ...
          <input type="submit" value="再投稿する" class="btn btn-primary">
        </div>
      </form>
      <!-- 本文ここまで -->
    </div>
